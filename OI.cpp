...
#include "Commands/RunShooterSlow.h"
#include "Commands/Nudge.h"
...
OI::OI() {
	...
	cStart->WhenReleased(new PyramidMode());
	...
	cButtonA->WhileHeld(new IntakeOnOff());
	...
	dButtonA->WhenPressed(new IntakeModeSwitch());
	SmartDashboard::PutData("Nudge", new Nudge());
}
