...
void FrontCorners::Execute() {
	...
	Robot::arm->controller->SetSetpoint(-29.75);
...
bool FrontCorners::IsFinished() {
	...
	return ((Robot::arm->armEncoder->GetDistance() - (-29.75)) <= 0.25 &&
			(Robot::arm->armEncoder->GetDistance() - (-29.75)) >= -0.25);    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=ISFINISHED
}
