...
void FrontCorners::Execute() {
	...
	Robot::arm->controller->SetSetpoint(-30.5);
...
bool FrontCorners::IsFinished() {
	...
	return ((Robot::arm->armEncoder->GetDistance() - (-30.5)) <= 0.25 &&
			(Robot::arm->armEncoder->GetDistance() - (-30.5)) >= -0.25);    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=ISFINISHED
}
