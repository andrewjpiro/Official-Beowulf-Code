...
void BackCorners::Execute() {
	...
	Robot::arm->controller->SetSetpoint(-28.75);
...
bool BackCorners::IsFinished() {
	...
	return ((Robot::arm->armEncoder->GetDistance() - (-28.75)) <= 0.25 &&
			(Robot::arm->armEncoder->GetDistance() - (-28.75)) >= -0.25);    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=ISFINISHED
}
