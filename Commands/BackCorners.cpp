...
void BackCorners::Execute() {
	...
	Robot::arm->controller->SetSetpoint(-29.0);
...
bool BackCorners::IsFinished() {
	...
	return ((Robot::arm->armEncoder->GetDistance() - (-29.0)) <= 0.25 &&
			(Robot::arm->armEncoder->GetDistance() - (-29.0)) >= -0.25);    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=ISFINISHED
}
